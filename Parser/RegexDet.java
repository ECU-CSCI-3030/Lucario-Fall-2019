		...
		do
		{
			...
			switch(x)
			{
				...
				case 1:{
					...
					System.out.println("I printed out the date: " + dateTest); 
					...
					String yr = dateTest.substring(6);
					...
					System.out.println("Day number is: " + dayNum);
					System.out.println("Month number is: " + monthNum);
					System.out.println("Year number is: " + yrNum);
				...
				case 2:{
					...
					//String dateTest = m.group(1) + " " + m.group(2) + " " + m.group(3);
					//String gro1 = m.group(1);
					String dateTest = m.group();
					System.out.println("I printed out the date: " + dateTest);
					//DateTimeFormatter formatter = DateTimeFormatter.ofPattern("EEEE, MMM dd");
					
					//MMM for Jan,Sep but MMMM for January
					
					//convert String to LocalDate
					//MonthDay monthDay = MonthDay.parse(dateTest, formatter);
					//int y = localDate.getMonthValue();
